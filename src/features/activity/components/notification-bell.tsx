...
const ACTION_VERB: Record<string, string> = {
  ...
  "release.created": "planned a release",
  "release.updated": "edited a release",
  "release.released": "shipped a release",
  "release.deleted": "deleted a release",
  "epic.created": "added an epic",
  "epic.updated": "edited an epic",
  "epic.deleted": "deleted an epic",
  "objective.created": "added an objective",
  "objective.updated": "edited an objective",
  "objective.deleted": "deleted an objective",
